...
class Level:
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.level_text(14, f'FPS: {clock.get_fps():.0f}', COLOR_WHITE,(16, WIN_HEIGHT - 35))
            self.level_text(14, f'ENTIDADES: {len(self.entity_list)}', COLOR_WHITE, (36, WIN_HEIGHT - 20))
            pygame.display.flip()
        pass
